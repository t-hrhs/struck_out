...
public class GameController : MonoBehaviour {
    ...
    void OnGUI () {
        ...
        Rect rect = new Rect(10, 20,(float)Config.s_width*0.9f,(float)Config.s_height*0.06f);
		string score = "スコア : ";
		GUI.Label(rect,score, style_for_status);
		Rect rect2 = new Rect (140, 20, (float)Config.s_width * 0.9f, (float)Config.s_height * 0.06f);
		string point = total_score.ToString() + "点";
		GUI.Label(rect2, point, style_for_status);
		Rect rect3 = new Rect(10,(float)Config.s_height*0.06f+30,(float)Config.s_width*0.9f,(float)Config.s_height*0.06f);
        string rest_ball = "残りボール数 : ";
        GUI.Label(rect3,rest_ball,style_for_status);
		Rect rect4 = new Rect(140,(float)Config.s_height*0.06f+30,(float)Config.s_width*0.9f,(float)Config.s_height*0.06f);
